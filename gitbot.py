...
class TwitterBot:
        ...
        try:
            ...
            response = openai.ChatCompletion.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": f"Create a quick, engaging reply to this tweet: '{tweet['text']}' by {tweet['author']}. Include relevant insights about AI or crypto. Keep it short and impactful."}
                ],
                max_tokens=60,
                temperature=0.9
            )
    ...
    def should_engage(self, tweet):
        ...
        return relevant_topics or is_peak_hour or tweet['author'] in TARGET_ACCOUNTS[:10]
